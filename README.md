...
# Installation
### Prerequisites
1. This bot uses the apple neuralhash model that you must source yourself and place in the local directory apple-neuralhash.  THIS REPOSITORY DOES NOT DISTRIBUTE THE MODEL.  I was able to source this from an Intel Macbook.  Instructions to do so are here: https://github.com/AsuharietYgvar/AppleNeuralHash2ONNX
